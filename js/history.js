        ...
        $.ajax({
            ...
            success: function(data){
                ...
                $.each(data[getMonthDate],function(i,n){
                    ...
                    str+='<p style="color: #858585;Font-style: italic;font-weight: bold;float: left;width: 100%;font-size: 14px;margin: 0px; padding: 0px;display: inline-block">';
                    str+='<i >A.D.</i>' +n.year + '</p>';
                    str+='<p style="width: 100%;float: left;font-weight: bold;margin: 0px; padding: 0px;font-size: 17px;display: inline-block" >';
